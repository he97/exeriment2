...
from data.swin_spatial_data import get_hsi_spatial_swin_dataloader, get_hsi_spatial_pca_swin_dataloader
...
def get_hsi_spatial_dataloader(config):
    if config.DATA.SPATIAL.PCA and not config.DATA.SPATIAL_ORIGIN:
        ...
        if config.DATA.SPATIAL.PCA:
            return get_hsi_spatial_pca_swin_dataloader(config)
